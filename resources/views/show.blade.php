        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="row">
                ...
                <div class="col">
                    ...
                    <p style="color:white;">Artista: {{ $data->artist }}</p>
                    <p style="color:white;">
                    Tracks:
                    <p hidden>{{ $c = 0 }}</p>
                    ...
                    <button type="submmit"><a href="https://www.youtube.com/watch?v="><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-right-square" viewBox="0 0 16 16">
                    ...
                    @csrf
                    <input hidden name="name" id="name" value="{{ $track->name }}">
                    <input hidden name="artist" id="artist" value="{{ $data->artist }}">
                    ...
                    @endif
                    <div class="a2a_kit a2a_kit_size_32 a2a_default_style" data-a2a-url="https://www.youtube.com/watch?v=" data-a2a-title="Example Page Title">
